...
- Make sure that this quiz is very challenging (level C1 to C2). This targeted test takers for this quiz are people with advanced English proficiency.
- Using complex grammars and hard vocabularies because this quiz is for the advanced level.
- The targeted test takers for this quiz are around 8.0 - 9.0 in IELTS Listening proficiency.
"""
