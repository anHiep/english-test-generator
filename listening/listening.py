...
from listening.qti import generate_qti
from listening.canvas import insert_mp3, upload_qti_to_canvas
from listening.generator import generate_listening_part1
...
def create_listening_quiz(content: str, quiz_idx: int, dist_path: str, topic: str, module):
    ...
    listening_part1, prompt = generate_listening_part1(content)
    ...
    generate_qti(listening_part1, quiz_idx, topic)
