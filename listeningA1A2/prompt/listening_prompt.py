...
- Make sure that this quiz is really easy (level A1 to A2). This targeted test takers for this quiz are beginners in English proficiency.
- Avoid complex grammar or hard vocabularies because this quiz is for the very beginners in English.
- The targeted test takers for this quiz are around 4.0 - 6.0 in IELTS Listening proficiency.
"""
