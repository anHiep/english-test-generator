...
class AgenticRAGAPI(ls.LitAPI):
    def setup(self, device):
        researcher_agent = Agent(
            ...
            backstory="You're a meticulous analyst with a keen eye for detail. You are a helpful assistant that can answer questions about the document.",
            verbose=True,
            tools=[SerperDevTool()],
            llm=llm
        )
        ...
        writer_agent = Agent(
            ...
            backstory="You're a meticulous analyst with a keen eye for detail. You are a helpful assistant that can write a report about the user's query",
            verbose=True,
            llm=llm
        )
